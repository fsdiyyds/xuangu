...
if __name__ == '__main__':
    ...
    selfid = '3xq5w9ss8drgf3g'
    pcursor = ''
    # ck =''  引号中间填登录后的 Cookie 值
    ck = 'kpf=PC_WEB; clientid=3; did=web_7a747964c8efbc334caae32291fd27be; userId=1225163093; kuaishou.server.web_st=ChZrdWFpc2hvdS5zZXJ2ZXIud2ViLnN0EqABFZPXBZupFMiZvFkBGcvEG8mdixV_traYhwaKSNuiim1KMhWBO9oyvy125yMx5l_zmVizB4kRpJa7UTVLdjZMetWgCMUse4H-rduL5MMhYfBs5Q31Kni6zUZmEFTjvHlEzfSkdQ1VhvcUp2GYIVXiMGavgFcGV1fM4Xucoo4eDH8jUtuuCbloX2C4S3Jz5m-CKKHUenDEi_4sTPO_MHRdiBoS7YoRGiN2PM_7zCD1Dj9m5oYoIiASPLD3Y2U2FjMzBNkSNYannp5a8ERr_877__uB8av2qygFMAE; kuaishou.server.web_ph=d523d7ca07ebde8de9516e0300cd694c3ecc; kpn=KUAISHOU_VISION'
    # ua = '' 引号中间填 User-Agent
